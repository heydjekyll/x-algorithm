...
from grox.flows.mm_emb.task_rate_limit import TaskRateLimitEmbeddingV8SearchForReply
from grox.flows.mm_emb.task_write_mm_embedding_sink import TaskWriteV8SearchSink


@register
class PlanPostEmbeddingV8SearchForReply(Plan):
    KEY = "mm_emb_v8_search_for_reply"

    TASKS = {
        "task_post_embedding_rate_limit_v8_search_for_reply": TaskRateLimitEmbeddingV8SearchForReply,
        ...
        "task_write_post_embedding_sink_v8_search": TaskWriteV8SearchSink,
    }

    TASK_DEPENDENCIES = {
        "task_post_embedding_rate_limit_v8_search_for_reply": set(),
        "task_post_embedding_filter_for_reply": {
            "task_post_embedding_rate_limit_v8_search_for_reply"
        },
